...
function displayPics() {
  ...
  // It threw an error because const is scoped to the block it is contained in.  When the code tried to run a console.log of it outside of that black, it threw an error.
  console.log(viewed);
